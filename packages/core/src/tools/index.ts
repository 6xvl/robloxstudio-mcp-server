...
export class RobloxStudioTools {
  ...
  private async passthrough(endpoint: string, body: any = {}) {
  ...
  // Terrain
  terrainFillBlock(body: any) { return this.passthrough('/api/terrain-fill-block', body); }
  terrainFillBall(body: any) { return this.passthrough('/api/terrain-fill-ball', body); }
  terrainFillWedge(body: any) { return this.passthrough('/api/terrain-fill-wedge', body); }
  terrainFillCylinder(body: any) { return this.passthrough('/api/terrain-fill-cylinder', body); }
  terrainClear() { return this.passthrough('/api/terrain-clear'); }
  terrainGetMaterials() { return this.passthrough('/api/terrain-get-materials'); }
  terrainReadVoxels(body: any) { return this.passthrough('/api/terrain-read-voxels', body); }

  // Lighting
  lightingListPresets() { return this.passthrough('/api/lighting-list-presets'); }
  lightingSetPreset(body: any) { return this.passthrough('/api/lighting-set-preset', body); }
  lightingGet() { return this.passthrough('/api/lighting-get'); }
  lightingSet(body: any) { return this.passthrough('/api/lighting-set', body); }

  // Compare (compareInstances exists upstream)
  diffSubtree(body: any) { return this.passthrough('/api/diff-subtree', body); }

  // Animation
  animationPlay(body: any) { return this.passthrough('/api/animation-play', body); }
  animationStop(body: any) { return this.passthrough('/api/animation-stop', body); }
  animationListTracks(body: any) { return this.passthrough('/api/animation-list-tracks', body); }
  animationLoadKeyframes(body: any) { return this.passthrough('/api/animation-load-keyframes', body); }

  // Particles
  particleCreate(body: any) { return this.passthrough('/api/particle-create', body); }
  particleTune(body: any) { return this.passthrough('/api/particle-tune', body); }

  // Sound
  soundPlayPreview(body: any) { return this.passthrough('/api/sound-play-preview', body); }
  soundStopPreview(body: any) { return this.passthrough('/api/sound-stop-preview', body); }
  soundLoadFromAssetId(body: any) { return this.passthrough('/api/sound-load-from-assetid', body); }
  soundSetEq(body: any) { return this.passthrough('/api/sound-set-eq', body); }
  soundSetReverb(body: any) { return this.passthrough('/api/sound-set-reverb', body); }

  // Tween
  tweenPreview(body: any) { return this.passthrough('/api/tween-preview', body); }

  // TextChat
  textchatConfigure(body: any) { return this.passthrough('/api/textchat-configure', body); }
  textchatCreateCommand(body: any) { return this.passthrough('/api/textchat-create-command', body); }
  textchatListChannels() { return this.passthrough('/api/textchat-list-channels'); }

  // Material
  materialListVariants() { return this.passthrough('/api/material-list-variants'); }
  materialCreateVariant(body: any) { return this.passthrough('/api/material-create-variant', body); }
  materialOverrideBase(body: any) { return this.passthrough('/api/material-override-base', body); }

  // Profiling
  profileStart(body: any) { return this.passthrough('/api/profile-start', body); }
  profileStop() { return this.passthrough('/api/profile-stop'); }
  profileSnapshot() { return this.passthrough('/api/profile-snapshot'); }

  // Extras
  humanoidDescriptionApply(body: any) { return this.passthrough('/api/humanoid-description-apply', body); }
  attributeSchemaValidate(body: any) { return this.passthrough('/api/attribute-schema-validate', body); }
  streamingenabledAudit() { return this.passthrough('/api/streamingenabled-audit'); }
  reparentInstance(body: any) { return this.passthrough('/api/reparent-instance', body); }
  insertService(body: any) { return this.passthrough('/api/insert-service', body); }
  generateMesh() { return this.passthrough('/api/generate-mesh'); }
  generateMaterial() { return this.passthrough('/api/generate-material'); }
  generateProceduralModel() { return this.passthrough('/api/generate-procedural-model'); }
  rojoStatus() { return this.passthrough('/api/rojo-status'); }
